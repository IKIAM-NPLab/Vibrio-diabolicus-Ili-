...
Preparing data and transneging feature table.

```{r echo=TRUE, message=FALSE, warning=FALSE, error=FALSE, results='hide'}

# Transneging feature height table
...
# Save plot
ggsave('Plots/PCA_NEG_H2O.png', width = 5, height = 4, device='pdf', dpi="print")
...
#Save plot
ggsave('Plots/LOADING_NEG_H2O.png', width = 10, height = 8, device='pdf', dpi="print")
...
ggsave('Plots/heatmap_NEG_QC.pdf', width = 5, height = 4, device='png', dpi="print")
...
# Save heatmap plot
ggsave(filename = "Plots/Firts_H2O_NEG_Heatmap.png", plot = negqc_hm,
