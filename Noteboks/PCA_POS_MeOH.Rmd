...
ggsave('Plots/PCA_POS_MeOH.png', width = 5, height = 4, device='pdf', dpi="print")
...
#Save plot
ggsave('Plots/LOADING_POS_MeOH.png', width = 10, height = 8, device='pdf', dpi="print")
...
ggsave('Plots/heatmap_POS_MeOH.pdf', width = 5, height = 4, device='png', dpi="print")
...
ggsave(filename = "Plots/Firts_MEOH_POS_Heatmap.png", plot = posqc_hm,
      width = 8, height = 5, units = "in", dpi = 600, scale = 2)
